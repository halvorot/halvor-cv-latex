...
% Override moderncv's orange with exact hex #F97316
\definecolor{color1}{HTML}{F97316}  % primary accent
\definecolor{color2}{HTML}{F97316}  % secondary accent (if used)
\definecolor{color3}{HTML}{F97316}  % tertiary accent (if used)
...
\section{Profile}
\cvitem{}{
Halvor Ødegård Teigen works as a backend developer with a parallel focus on DevOps. He has a solid academic background with a Master's degree in cybernetics and robotics from NTNU. Through his engagements at Statens Vegvesen, Statnett, and BarentsWatch, he has demonstrated proficiency in Java, Spring Boot, Kafka, and React, and gained experience as both team lead, scrum master and developer in interdisciplinary autonomous teams with an agile development methodology.
}
\cvitem{}{
Halvor is committed to continuous growth and has invested time in several certifications and courses. He is ISTQB-certified in several test areas, Kafka-accredited through Confluent, and has completed courses in both Java, Kotlin and AWS.
}
\cvitem{}{
With three years of experience as a developer, Halvor has taken on roles such as Java backend developer, full stack developer and team lead. As part of an enablement team at Statnett he has developed applications and frameworks intended to simplify quality assurance of event-based systems. Halvor has also had a central role in the development of CI/CD pipelines for automatic integration and value chain tests in temporary environments in OpenShift.
}
\cvitem{}{
...
\cvitem{Cloud}{AWS}
\cvitem{DevOps}{Kubernetes, Docker, GitLab, GitHub}
...
\section{Relevant courses and certifications}
...
\cvitem{}{\textit{See 'Project details' below for more detailed info on each project.}}
...
\cvitem{08.2022--04.2024}{\textbf{Statnett - DevOps and Test automation} \-- Developer, Team lead}
\cvitem{03.2022--07.2022}{\textbf{Sopra Steria Service development - Test Data Service} \-- Researcher, Developer}
\cvitem{09.2021--02.2022}{\textbf{Norwegian Public Roads Administration - Syntopia} \-- Data Scientist, Backend developer}
\cvitem{01.2021--06.2021}{\textbf{NTNU - Master Thesis} \-- Author, Developer}
\cvitem{08.2020--12.2020}{\textbf{NTNU - Specialization Project} \-- Author, Developer}
...
\section{Project details}\label{sec:project-details}
...
\cvitem{\textbf{Competencies:}}{General Data Protection Regulation (GDPR), Service development, Data modeling, FastAPI, Sales, SQLAlchemy, React.js, Python, Pandas, Artificial intelligence (AI), Presentation skills, Differential Privacy}
\cvitem{\textbf{Roles}}{%
...
\subsection{\textbf{Norwegian Public Roads Administration}}
\cvitem{\textbf{Assignment:}}{Syntopia}
\cvitem{\textbf{Competencies:}}{SQL, Python, Pandas, Atlassian Bitbucket, Java, Spring Boot, Pytest, JPA, Hibernate, Jenkins, General Data Protection Regulation (GDPR), Postman, Test data}
\cvitem{Roles}{%
...
\cvitem{}{
Halvor planned and conducted workshops with testers and developers within the Norwegian Public Roads Administration to map their needs and requirements for the solution. He also conducted workshops with external actors with the purpose of gaining experience from other similar projects.
}
